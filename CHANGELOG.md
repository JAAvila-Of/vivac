...
- *(cli)* let vivac update install once the person says yes ([#179](https://github.com/JAAvila-Of/vivac/pull/179))
...
- *(migrate)* share a large batch's reading among subagents ([#172](https://github.com/JAAvila-Of/vivac/pull/172))
...
## [0.15.0](https://github.com/JAAvila-Of/vivac/compare/v0.14.2...v0.15.0) - 2026-09-24
...
## [0.14.2](https://github.com/JAAvila-Of/vivac/compare/v0.14.1...v0.14.2) - 2026-09-23

### Added

- *(push)* open work under the node it continues, not the focus

## [0.14.1](https://github.com/JAAvila-Of/vivac/compare/v0.14.0...v0.14.1) - 2026-09-23

### Added

- *(brief)* tell the agent at which seams to write, in the opening hook
